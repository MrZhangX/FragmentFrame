...
public class DemoFragment5 extends BaseSupportFragment {
    ...
    public static DemoFragment5 newInstance(int p1, String p2) {
        Bundle args = new Bundle();
        args.putInt("param1", p1);
        args.putString("param2", p2);
        DemoFragment5 fragment = new DemoFragment5();
